...
\subsection{Körper}
%@Aaron Das hier ist noch dein Part // Siehe: MathematikFürDieInformatik S. 364
% Vllt findest du aber auch eine bessere Definition.

Ein Körper ist eine spezielle Form des Rings. Die Definition des Körpers wurde aus \cite[vgl.][S. 364-365]{Berghammer.2021} entnommen. Ein Ring $(K,0,1,+,\cdot,-)$ heißt oder gilt als \textbf{Körper}, wenn er kommutativ ist sowie gilt, dass $0 \neq 1$. Weiterhin muss folgende Formel $$x \neq 0 \Rightarrow \exists y \in K : yx = 1$$ für alle $x \in K$ gelten.\\
