...
In diesem Kapitel wird die Umsetzung der theoretisch behandelten Konzepte in Python thematisiert. Im Zuge dessen, werden auch die verwendeten Bibliotheken und die Programmiersprache Python kurz thematisiert.\\
...
\subsection{Methode: get\_all\_points\_on\_curve()}\label{sec:python_points}
...
\subsection{Funktion: extended\_euclidean\_algorithm()}\label{sec:python_euklid}
