...
Stellt man die Gleichung der Funktion nach $y^{2}$ um, dann erhält man folgendes:
\begin{center}
$y^{2} =  x^{3}$ + ax + b  mod p,
\end{center}

wobei $a, b \in Z_p $. Diese Gleichung ist der Schlüssel für die im Voraus aufgeworfene Frage, was ein Punkt einer elliptischen Kurve ist. Diese sind nämlich alle Punkte (x, y), welche die Gleichung lösen und gleichzeitig die Bedingung $4a^3 + 27b^2 \neq 0 mod p$ erfüllen.
