...
Der Pseudocode zeigt lediglich eine beispielhafte Umsetzung mittels Pseudocode. In \ref{sec:python_add_double} wird der ausprogrammierte Python-Code inklusive Erklärungen angegeben und weiter ausgeführt.\\
...
$$y_3 = s(x_1 - x_3) - y_1 = 1(5 - 3) - 1 = 1 \equiv 6 \text{ mod } 17$$
...
Damit ist $18 \cdot P = (5, 16)$. $19 \cdot P = P + Q = (5, 1) + (5, 16) = \infty $, wobei Q = $18 \cdot P$. Der Punkt im unendlichen wurde erreicht, womit nun alle Punkte gefunden wurden.\\
...
\subsection{Diskreter Logarithmusproblem über elliptischen Kurven}
